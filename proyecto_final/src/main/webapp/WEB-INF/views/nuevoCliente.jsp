		...
		<h3>Agregar Cliente</h3>
			<div class="form-row">
			    ...
			    <div class="form-group col-md-4">
			      ...
			      <input type="text" class="form-control form-control-sm" id="txtRut">
			    </div>
			...
			<div class="form-row">
				<div class="form-group col-md-4">
			      ...
			      <input type="text" class="form-control form-control-sm" id="txtRubro">
			    </div>	    
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
			    ...
			    <div class="form-group col-md-1">
			      ...
			      <input type="text" class="form-control form-control-sm" id="txtNum">
			    </div>	    
			</div>
			<div class="form-row">
				<div class="form-group col-md-4">
