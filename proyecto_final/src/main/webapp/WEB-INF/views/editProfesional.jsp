...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/guardarProfesional" method="post">
		...
		<input type="hidden" name="id_persona" value="${p.getId_persona()}">
		<div class="container formulario">
		<h3>Agregar Profesional</h3>
			<div class="form-row">
				<div class="form-group col-md-4">
			      <label for="txtRazonSocial">Rut</label>
			      <input type="text" class="form-control form-control-sm" name="rut" value="${p.getRut()}">
			    </div>
			    <div class="form-group col-md-4">
			      <label for="txtRut">Nombre</label>
			      <input type="text" class="form-control form-control-sm" name="nombre" value="${p.getNombre()}">
			    </div>
			...
			<div class="form-row">
				<div class="form-group col-md-4">
			      ...
			      <input type="text" class="form-control form-control-sm" name="ap_paterno" value="${p.getAp_paterno()}">
			    </div>	    
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
			      <label for="txtDireccion">Apellido Materno</label>
			      <input type="text" class="form-control form-control-sm" name="ap_materno" value="${p.getAp_materno()}">
			    </div>
			    <div class="form-group col-md-1">
			      <label for="txtNum">Edad</label>
			      <input type="number" class="form-control form-control-sm" name="edad" value="${p.getEdad()}">
			    </div>	    
			</div>
